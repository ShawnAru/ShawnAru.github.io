    ...
    xhttp.onreadystatechange = function() {
      if(this.readyState == 4 && this.status == 200) {
       ...
       eluserImage.title = data.results[0].name.first + " " + data.results[0].name.last;
         ...
         eladdress.innerHTML = data.results[0].location.street.number + ", " + data.results[0].location.street.name +", <br/>" + data.results[0].location.city + ", <br/>" + data.results[0].location.postcode + " " + data.results[0].location.state +", <br/>" + data.results[0].location.country + ",<br/> Lat = " + data.results[0].location.coordinates.latitude + ",<br/> Long = " + data.results[0].location.coordinates.longitude;
